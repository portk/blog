...
CREATE TABLE IF NOT EXISTS `file` (
  `uid` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `post` (`post_id`, `board_id`, `writer`, `post_title`, `post_context`, `post_date`, `post_modify`, `read_count`, `post_recommand`) VALUES
	(1, 1, 'tester1', 'post1', 'postContext', '2023-11-24 10:34:01', 0, 0, 0),
	...
	(5, 2, 'tester1', 'post3', 'posttest2', '2023-11-24 15:03:14', 1, 0, 0),
...
INSERT INTO `reply` (`reply_id`, `post_id`, `writer`, `reply_context`, `reply_date`, `reply_modify`, `sub_id`) VALUES
	...
	(4, 2, 'tester2', 'reply1e', '2023-12-03 02:54:36', 1, NULL),
